...
<title>Alabaster Car Rentals | Vehicle Details</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>GH₵<?php echo htmlentities($result->PricePerDay);?> </p>Per Day
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <textarea rows="2" class="form-control" name="destination" placeholder="Destination" required></textarea>
            </div>
            <div class="form-group">
