...
<title>Alabaster Car Rentals</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Find the ideal car for your adventure!.</h1>
            <p>Choose the best car for your next trip. Swift, Safe & Reliable! </p>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h3>Welcome To Alabaster Car Rentals and Tours Ltd</h3>
      <p>Unleash the freedom to explore as you choose from our diverse fleet of reliable vehicles. Whether it's sleek city ride or an adventurous SUV, find the perfect wheels for your journey. Enjoy competitive rates, flexible booking options, and exceptional customer service. Your road adventure begins with Alabaster - where every mile is a memorable experience!</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">OUR RENTAL FLEET</a></li>
        </ul>
      </div>
...
<span class="price">GH₵<?php echo htmlentities($result->PricePerDay);?> /Day</span> 
</div>
